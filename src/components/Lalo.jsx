...
const Lalo = (props) => {
  ...
  const bookings_idx = rand + (hour*5) + hour
  console.log(props);
  // function clicked(){
  //     setItIsOpen(false)
  // }
        ...
        <div>
          ...
          <div className="child" style={{ marginTop: "20px", display:"flex",justifyContent:'space-around' }}>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;{bookings}<br/>
              ...
              <h1 style={{fontSize:"3em", color:"#72ED2F", marginTop:"45px", fontWeight:"bold"}}>{bookings_idx}</h1>
              <p style={{color:"#72ED2F", paddingTop:"20px"}}>Bookings<br/> made</p>
            </p>
