...
function Home() {
  const data = [
    {
      name: "Groceries 24/7",
      number: "+254115144146",
      message: "Hello Goombay 😊 I need groceries 🧅",
      className: "whatsapp",
      image: groceries,
      desc: "image desc",
    },
  ...
  return (
    <div className="container">
      ...
      <ReactWhatsapp
            number={"+254115144146"}
            message={"Hello Goombay 😊 I need Food / drinks 📦"}
            className="whatsapp"
          >
       ...
       <ReactWhatsapp
              number="+254115144146"
              message="Hello Goombay 😊 I need to rent a Scooter/ E-Bike/ Car/ Taxi /Boat 🚗"
              className="whatsapp"
            >
          <div className="Tab-item">
        ...
        <ReactWhatsapp
              number="+254115144146"
              message="Hello Goombay 😊 I need  ParcelDelivery / Hire a Tech Guru / Repair 🛠️"
              className="whatsapp"
            >
        ...
        <h4 style={{paddingTop:"30px"}}>24/7 BOOKINGS {bookingicon}</h4>
          <ReactWhatsapp
            number={"+254115144146"}
            message={"Hello Goombay 😊 I need  accomodation 🛌"}
            className="whatsapp"
          >
            <div className="Tab-item">
          ...
          <ReactWhatsapp
            number={"+254115144146"}
            message={"Hello Goombay 😊 I need a dinner reservation 🍽️"}
            className="whatsapp"
          >
            <div className="Tab-item">
          ...
          <ReactWhatsapp
            number={"+254115144146"}
            message={"Hello Goombay 😊 I need Airport Transportation ✈️"}
            className="whatsapp"
          >
            <div className="Tab-item">
          ...
          <ReactWhatsapp
            number={"+254115144146"}
            message={"Hello Goombay 😊 I need  Cash & currency exchange 💰"}
            className="whatsapp"
          >
            <div className="Tab-item">
        ...
        <ReactWhatsapp
            number={"+254115144146"}
            message={"Hello Goombay 😊 I need to spend some crypto 💸"}
            className="whatsapp"
          >
            <div className="Tab-item">
          ...
          {/* <ReactWhatsapp
            number={"+254115144146"}
            message={"Hello Goombay 😊 I need shopping 🛒"}
            className="whatsapp"
          >
            <div className="Tab-item">
          ...
          <ReactWhatsapp
            number={"+254115144146"}
            message={"Hi GoomBaypp I want to book accomodation."}
            className="whatsapp"
          >
            <div className="Tab-item">
          ...
          <ReactWhatsapp
            number={"+254115144146"}
            message={"Hello Goombay 😊 I need Package Delivery(Amazon US) 📦"}
            className="whatsapp"
          >
            <div className="Tab-item">
          ...
          <ReactWhatsapp
            number={"+254115144146"}
            message={"Hello Goombay 😊 I need Package Delivery(Amazon UK/EUR) 📦"}
            className="whatsapp"
          >
            <div className="Tab-item">
            <div className="grid-left">{amazon}</div>
