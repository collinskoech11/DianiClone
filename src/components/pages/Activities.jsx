  ...
  const data = [
    {
        ...
        message: "Hi JingerApp 😊, Im interested in Sunset/Sunrise Boat Trip 🛥️",
        number: "+254773287540",
        background: imagebg,
    ...
    },
    {
        name: "Glassboat Trip",
        number: "+254773287540",
        message: "Hi JingerApp 😊, Im interested in Glassboat Trip 🛥️",
    ...
    },
    {
        ...
        number: "+254773287540",
        message: "Hi JingerApp 😊, Im interested in Dolphin Watching 🐬",
        background: dolphins,
    ...
    },
    {
        name: "Quad Bike Tour",
        number: "+254773287540",
        message: "Hi JingerApp 😊, Im interested in Quad Bike Tour 🏍️",
        background: quad,
    ...
    },
    {
        name: "Golf",
        number: "+254773287540",
        message: "Hi JingerApp 😊, Im interested in Golf 🏌️",
        background: golf,
    ...
    },
    {
        name: "Camel Rides",
        number: "+254773287540",
        message: "Hi JingerApp 😊, Im interested in Camel rides🐫 ",
        background: camel,
    ...
    },
    {
        name: "Snorkeling",
        number: "+254773287540",
        message: "Hi JingerApp 😊, Im interested in snorkelling 🤿",
