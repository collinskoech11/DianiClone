  ...
  const data = [
    {
        ...
        message: "Hi Goombay 😊, Im interested in Sunset/Sunrise Boat Trip 🛥️",
        number: "+254773287540",
        background: imagebg,
    ...
    },
    {
        name: "Glassboat Trip",
        number: "+254773287540",
        message: "Hi Goombay 😊, Im interested in Glassboat Trip 🛥️",
    ...
    },
    {
        ...
        number: "+254773287540",
        message: "Hi Goombay 😊, Im interested in Dolphin Watching 🐬",
        background: dolphins,
    ...
    },
    {
        name: "Quad Bike Tour",
        number: "+254773287540",
        message: "Hi Goombay 😊, Im interested in Quad Bike Tour 🏍️",
        background: quad,
    ...
    },
    {
        name: "Camel Rides",
        number: "+254773287540",
        message: "Hi Goombay 😊, Im interested in Camel rides🐫 ",
        background: camel,
    ...
    },
    {
        name: "Snorkeling",
        number: "+254773287540",
        message: "Hi Goombay 😊, Im interested in snorkelling 🤿",
